 ...
 */
fun myProfile() {
    val firstname :String  = "Anjas"
    val middlename :String = "Muhamad"
    val lastname :String = "Rafi"
    val umur : Int = 22
    val status: Boolean = true
    if (status) {
        println("Nama saya " + firstname + " " + middlename + " " + lastname + " umur saya " + umur + " status saya " + "single")
    } else {
        println("Nama saya " + firstname + " " + middlename + " " + lastname + " umur saya " + umur + " status saya " + "pacaran")
    }
}
...
fun groupDetail(groupId: Int, groupMember: List<Any>, session: String): Any {
    println ("Nama-nama anggota group : " + groupMember + " Group : " + groupId + " Sesi : " + session)
 ...
 */
fun myName(): String {
    val member = arrayOf("Alex" ,"Andre" ,"Anjas" ,"Ferry" ,"Zidan")
